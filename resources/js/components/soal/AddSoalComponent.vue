                    ...
                    <div class="row">
                        <div class="col-md-8">
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                      <vue-simplemde  v-model="form.soal" ref="markdownEditor" />
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="name" class="control-label col-md-3">Jawaban A</label>
                                <div class="col-md-8">
                                    <input type="text" v-model="form.jawaban_a"  name="a" class="form-control">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    <input type="text" v-model="form.jawaban_b"  name="b" class="form-control">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    <input type="text"  v-model="form.jawaban_c" name="c" class="form-control">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    <input type="text"  v-model="form.jawaban_d" class="form-control" name="D">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    <select class="form-control"  v-model="form.knc_jawaban"  name="knc_jawaban">
                    ...
                    <div class="col-md-8">
                        <div class="row">
                            <div class="col-md-offset-3 col-md-6">
                                <button @click="save()" type="submit" class="btn btn-primary">Simpan</button>
